...
<head>
    ...
    <link rel="stylesheet" href="css/font-awesome.css" rel="stylesheet"><!-- font-awesome-icons -->
        ...
        <div class="col-md-9">
            ...
            <div class="biz-info-area">
                <form id="profile-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <p><span>Enterprise Name</span><input type="text" name="name"
                                                          value="<?php echo $business_info->name; ?>"/></p>
                    <p><span>Enterprise Number</span><input type="number" name="number"
                                                            value="<?php echo $business_info->number; ?>"/></p>
                    <p><span>Registration Date</span><input type="date" name="date"
                                                            value="<?php echo $business_info->date; ?>"/></p>
                    <p><span>Enterprise Address</span><input id="autocomplete" type="text" name="address"
                                                             value="<?php echo $business_info->address; ?>"/></p>
                    <input type="hidden" name="bio" value="<?php echo $business_info->bio; ?>"/>
                    <p><label for="phase">Business Phase</label>
                    ...
                    <p><label for="industry">Business Industry </label>
                    ...
                    <p><span>Products and/Services</span><textarea name="offering" cols="40"
            ...
            <div class="biz-concept-area"><h4>Business Concepts Questions</h4>
                <hr class="divider">
                <table>
                    <?php
                    $i = 0; ?>
            ...
            </div> <!--/ business concept section -->

            <!-- business structure section -->
            <div class="biz-structure-area"><h4> Business Structure Questions </h4>
                <hr class="divider">
                <table>
                    <?php
                    $talent_index = 0;
            ...
            </div> <!--/ business structure section -->
